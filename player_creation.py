...
sample_lineup_one = [batter(.250, .300, 20, 30, .400, 5, 6, 'CF', "Jackson Chourio"), 
                     batter(.250, .300, 25, 30, .400, 5, 6, 'LF', "Isaac Collins"), 
                     batter(.250, .300, 28, 30, .400, 5, 6, 'RF', "Sal Frelick"), 
                     batter(.250, .300, 3, 30, .400, 5, 6, '1B', "Andrew Vaughn"), 
                     batter(.250, .300, 45, 30, .400, 5, 6, '2B', "Brice Turang"),
                     batter(.250, .300, 13, 30, .400, 5, 6, '3B', "Caleb Durbin"),
                     batter(.250, .300, 4, 30, .400, 5, 6, 'C', "William Contreras"),
                     batter(.250, .300, 14, 30, .400, 5, 6, 'SS', "Joey Ortiz"),
                     batter(.250, .300, 25, 30, .400, 5, 6, 'DH', "Christian Yelich"),
...
sample_lineup_two = [batter(.250, .300, 30, 30, .400, 5, 6, 'CF', "Willie Mays"), 
                     ...
                     batter(.250, .300, 21, 30, .400, 5, 6, 'SS', "Derek Jeter"),
                     batter(.250, .300, 5, 30, .400, 5, 6, 'DH', "Jim Edmonds"),
